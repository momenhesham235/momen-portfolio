...
export const projectsData = [
  ...
  },
  {
    ...
    performance: ["Fast page loading", "SEO-friendly rendering", "Optimized assets"],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    tech: [
      "React", "Zustand", "Axios", "Framer Motion",
      "Swiper", "React hot toast", "React icons",
    ],
    performance: [
      "Fast page loading",
  ...
  },
  {
    ...
    tech: ["React", "React Bootstrap", "Redux", "Axios", "React Hook Form", "Zod"],
    performance: [
      "Fast page loading",
      "Optimized component rendering",
      "Cross-browser compatibility",
